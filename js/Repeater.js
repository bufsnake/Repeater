...
function loadURL() {
    chrome.tabs.query({
        ...
        chrome.runtime.sendMessage({
                action: 'Get Session Storage',
                data: 'request_body_' + id
            },
            function (response) {
...
function send_form(tabs, count) {
    if (count > 3) {
        return $.growl.error({
            title: 'ERROR',
            message: 'LOAD FORM FAIL',
        })
    }
    // get devtools form
    var message = {
    ...
    console.log('Current Tab Id Is', tabs)
